...
import { deleteProjet } from "@/api/ProjectApi";
...
export default function DeleteProjectModal() {
  ...
  // y nos permite invalidar o actualizar la caché de las consultas
  ...
  // y nos permite manejar el estado de la mutación
   ...
   const deleteProjectMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      // invalidar la consulta de los proyectos para que se vuelva a cargar
